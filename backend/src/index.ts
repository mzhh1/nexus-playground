...
// Actions are now handled by Engine DO via WebSocket
// Perspectives are generated by Engine DO and pushed via WebSocket
  ...
  await fastify.register(
    async (instance) => {
      ...
      instance.register(async (protectedInstance) => {
        ...
        protectedInstance.register(roomsRoutes); // Engine connection (JWT signing)
      });
    },
    { prefix: '/api/v1' }
  );
